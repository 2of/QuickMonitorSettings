                    ...
                    GlassSection(title: "Dock Settings") {
                        VStack(spacing: 10) {
                            ...
                            HStack {
                                ...
                                Spacer()
                                Toggle("", isOn: asyncBinding(configBinding.minimizeToApplication))
                                    .toggleStyle(.switch)
                                    .labelsHidden()
                                    .controlSize(.small)
                            }
                            ...
                            HStack {
                                ...
                                Spacer()
                                Toggle("", isOn: asyncBinding(configBinding.animateOpening))
                                    .toggleStyle(.switch)
                                    .labelsHidden()
                                    .controlSize(.small)
                            }
                            ...
                            HStack {
                                ...
                                Spacer()
                                Toggle("", isOn: asyncBinding(configBinding.showIndicators))
                                    .toggleStyle(.switch)
                                    .labelsHidden()
                                    .controlSize(.small)
                            }
